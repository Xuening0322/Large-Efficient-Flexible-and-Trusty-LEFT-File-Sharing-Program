# Step 1: copy your codes (.py files) to "program" folder
...
PC_A_IP = ('192.168.49.128', 8001)  # 8001 is not for you! 8001 端口不是给你用的。
...
if __name__ == '__main__':
    ...
    inspector_th1 = threading.Thread(target=run_inspector, args=(code_list, PC_A_IP[0], '192.168.56.1', PC_A_IP[1], 'PC_A_IP', 'program/', ))
    inspector_th1.daemon = True
    inspector_th1.start()

    inspector_th2 = threading.Thread(target=run_inspector, args=(code_list, PC_B_IP[0], '192.168.56.1', PC_B_IP[1], 'PC_B_IP', 'program/', ))
